...
**Current version:** v0.4.5-dev.1  
**Tested with:** The Lounge 4.5.2  
**Browsers tested:** Chrome on Android and desktop

## Scope

v0.4.5-dev.1 is explicitly scoped to the **DarkPeers** IRC network, but it no longer depends on whatever local name you gave that connection in The Lounge.
