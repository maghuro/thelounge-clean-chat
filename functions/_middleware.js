...
export async function onRequest(context) {
    ...
    // Analytics are strictly opt-in. The normal stylesheet URL serves CSS
    // without recording anything. Only an explicit ?stats query parameter
    // contributes a datapoint (both ?stats and ?stats=1 are accepted).
